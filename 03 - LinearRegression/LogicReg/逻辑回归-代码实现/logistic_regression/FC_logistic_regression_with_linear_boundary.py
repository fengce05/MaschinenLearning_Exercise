...
from FC_logistic_regression import LogisticRegression


data = pd.read_csv('/Users/fengce/Desktop/ML/ML_algorithm_study/LogicReg/逻辑回归-代码实现/logistic_regression/data/iris.csv')
...
accuracy = np.mean(y_train_predictions == y_train)*100
